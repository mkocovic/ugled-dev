...
const featureIconMapping: Record<UlaznaFeatureIconKey, LucideIcon> = {
  Shield: icons.Shield,
...
export default function UlaznaDoorsPage() {
  const { title, subtitle, heroImage, features, types, gallery, technicalSpecifications, cta } = ulaznaConfig;
